...
--     -- Get the base raw records and mark if they were rejected
--     SELECT
--         t.sale_surrogate_key,
--         t.supplier_key,
--         t.store_key,
...
--     -- Union the rejected records, marking them as rejected
--     SELECT
--         r.sale_surrogate_key,
--         d_s.supplier_key,
--         d_store.store_key,
--         TRUE AS is_rejected,
--         CAST(1 AS Int64) AS total_record_count
...
-- SELECT
--     *,
--     -- Mark for review if 5% or more of records were rejected
--     CASE 
...
-- models/gold/rpt_dq_supplier_reliability.sql
